        ...
        <main v-else class="pack-list shared-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p class="scroll-indicator">Puedes desplazarte y arrastrar para ver más Packs.</p>
                    <h3>sobre los packs</h3>
                    <p>
                       Estos Packs son básicamente "Packs de Jugadores". Se incluyen todos los packs de cada jugador, si quieres añadir tu propio pack, avisarle a la administracion de la pagina
                    </p>
                    <h3>¿Cómo puedo conseguir estos packs?</h3>
                    <p>
                        Los packs aparecerán automáticamente en tu perfil cuando hayas completado todos los niveles asignados. (Los niveles inéditos no se contabilizan para completar los packs).
                    </p>
                </div>
            </div>
